                ...
                <li className="py-16">
                    <div className="grid grid-cols-4">
                        ...
                        <div className="col-span-3 space-y-2">
                            ...
                            <p className="text-green-500">期刊：Medical Image Analysis</p>
                            <p className="text-green-500">第二作者</p>
                            <p className="text-green-500">影响因子: 13.828</p>
                            <p className="text-green-500">被引次数: 72</p>
                        </div>
                    </div>
                </li>
                <li className="py-16">
                    <div className="grid grid-cols-4">
                        ...
                        <div className="col-span-3 space-y-2">
                            ...
                            <p className="text-green-500">期刊：Neurocomputing</p>
                            <p className="text-green-500">第二作者</p>
                            <p className="text-green-500">影响因子: 5.779</p>
                            <p className="text-green-500">被引次数: 6</p>
                        </div>
                    </div>
                </li>
                <li className="py-16">
                    <div className="grid grid-cols-4">
                        ...
                        <div className="col-span-3 space-y-2">
                            ...
                            <p className="text-green-500">期刊：Information Sciences</p>
                            <p className="text-green-500">第二作者</p>
                            <p className="text-green-500">影响因子: 8.233</p>
                            <p className="text-green-500">被引次数: 4</p>
                        </div>
                    </div>
                </li>
                <li className="py-16">
                    <div className="grid grid-cols-4">
                        ...
                        <div className="col-span-3 space-y-2">
                            ...
                            <p className="text-green-500">期刊：IEEE Transactions on Medical Imaging</p>
                            <p className="text-green-500">第三作者</p>
                            <p className="text-green-500">影响因子: 11.037</p>
                            <p className="text-green-500">发表状态: Early Access</p> 
                        </div>
                    </div>
                </li>
            </ul>
